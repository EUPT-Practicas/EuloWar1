...
public class OperacionesCombates {
    ...
    /**
     * Elige un rival para un ataque en funcion de los niveles de fabrica
    ...
    public Usuario elegirRival(@WebParam(name = "email") String email) {
        ...
        FabricaDefensiva fabricaRival = null;
    ...
    public Usuario simularCombate(@WebParam(name = "emailAtacante") String emailAtacante, @WebParam(name = "emailDefensor") String emailDefensor) {
        ...
        System.out.println("FUERA DE LOS FOR");
        ...
        do {
            ...
            if (fuerzaAtaqueRival == 0) {
                fuerzaAtaqueRival = 1;
            }

            if (fuerzaDefensaRival == 0) {
                fuerzaDefensaRival = 1;
            }
            ...
            System.out.println(fuerzaAtaqueDefinitiva);
            System.out.println(fuerzaDefensaDefinitiva);
